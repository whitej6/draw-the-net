...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 1.6.1)
- `project_name`: the default docker compose project name (default: `draw_the_net`)
...
#14 naming to docker.io/draw-the-net/nautobot:1.6.1-py3.7 done
```
...
Creating network "draw_the_net_default" with the default driver
Creating volume "draw_the_net_postgres_data" with default driver
Creating draw_the_net_redis_1 ...
Creating draw_the_net_docs_1  ...
Creating draw_the_net_postgres_1 ...
Creating draw_the_net_postgres_1 ... done
Creating draw_the_net_redis_1    ... done
Creating draw_the_net_nautobot_1 ...
Creating draw_the_net_docs_1     ... done
Creating draw_the_net_nautobot_1 ... done
Creating draw_the_net_worker_1   ...
Creating draw_the_net_worker_1   ... done
...
ee90fbfabd77   draw-the-net/nautobot:1.6.1-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               draw_the_net_worker_1
b8adb781d013   draw-the-net/nautobot:1.6.1-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   draw_the_net_nautobot_1
d64ebd60675d   draw-the-net/nautobot:1.6.1-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   draw_the_net_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   draw_the_net_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   draw_the_net_redis_1
```
...
Stopping draw_the_net_worker_1   ...
Stopping draw_the_net_nautobot_1 ...
Stopping draw_the_net_docs_1     ...
Stopping draw_the_net_redis_1    ...
Stopping draw_the_net_postgres_1 ...
Stopping draw_the_net_worker_1   ... done
Stopping draw_the_net_nautobot_1 ... done
Stopping draw_the_net_postgres_1 ... done
Stopping draw_the_net_redis_1    ... done
Stopping draw_the_net_docs_1     ... done
Removing draw_the_net_worker_1   ...
Removing draw_the_net_nautobot_1 ...
Removing draw_the_net_docs_1     ...
Removing draw_the_net_redis_1    ...
Removing draw_the_net_postgres_1 ...
Removing draw_the_net_postgres_1 ... done
Removing draw_the_net_docs_1     ... done
Removing draw_the_net_worker_1   ... done
Removing draw_the_net_redis_1    ... done
Removing draw_the_net_nautobot_1 ... done
Removing network draw_the_net_default
```
...
So for example, our plugin is named `draw-the-net`, the command would most likely be `docker logs draw_the_net_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("draw_the_net")
namespace.configure(
    {
        "draw_the_net": {
            ...
...
Or set the `INVOKE_DRAW_THE_NET_PYTHON_VER` variable.
...
Or set the `INVOKE_DRAW_THE_NET_NAUTOBOT_VER` variable.
